...
describe('formattedNumber', () => {
  ...
  describe('very small values bug fix', () => {
    ...
    it('should handle values just above threshold', () => {
      const result = formattedNumber(0.00011)
      expect(result).toBe('0.000')
    })
  ...
  describe('complete snapshots', () => {
    it('should match snapshot for typical token balance', () => {
      const result = formattedNumber(1234.567, {
        fractionDigits: 3,
        suffix: 'LEO',
      })
      expect(result).toMatchSnapshot()
    ...
    it('should match snapshot for USD value', () => {
      const result = formattedNumber(9876.54, {
        fractionDigits: 2,
        prefix: '$',
      })
      expect(result).toMatchSnapshot()
    ...
    it('should match snapshot for high-precision value', () => {
      const result = formattedNumber(0.123456789, {
        fractionDigits: 8,
      })
      expect(result).toMatchSnapshot()
    })
