...
describe('markdownToHTML() method', () => {
  ...
  describe('parameters', () => {
    it('should handle forApp=true for external links', () => {
      ...
      const result = markdownToHTML(input, true, false, 'ecency.com')
    ...
    it('should pass parentDomain to Twitch embeds', () => {
      ...
      const result = markdownToHTML(input, false, false, 'example.org')
      expect(result).toContain('parent=example.org')
    })

    it('should use default parentDomain when not specified', () => {
      const input = 'https://www.twitch.tv/channelname'
      const result = markdownToHTML(input, false, false)
  ...
  describe('error handling', () => {
    it('should handle empty input', () => {
      const result = markdownToHTML('', false, false, 'ecency.com')
      expect(result).toBe('')
    })
    ...
    it('should handle malformed markdown gracefully', () => {
      ...
      expect(() => markdownToHTML(input, false, false, 'ecency.com')).not.toThrow()
      const result = markdownToHTML(input, false, false, 'ecency.com')
      expect(result).toBeTruthy()
    })
    ...
    it('should handle very large input', () => {
      ...
      expect(() => markdownToHTML(largeInput, false, false, 'ecency.com')).not.toThrow()
      const result = markdownToHTML(largeInput, false, false, 'ecency.com')
      expect(result).toBeTruthy()
    })
