...
export function sanitizeHtml(html: string): string {
  return xss(html, {
    ...
    onTagAttr: (tag, name, value) => {
      ...
      // Strip user-supplied srcset - only allow srcset generated by our renderer
      if (tag === 'img' && name === 'srcset') {
        // Each srcset candidate must be https:// - reject if any candidate uses a non-https protocol
