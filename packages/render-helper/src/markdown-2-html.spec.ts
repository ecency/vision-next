...
const SNAPSHOT_JSON = {
  ...
  "markdown_2_html_webp_support_should_render_images_in_match_format": `<p dir=\"auto\">lorem ipsum <img class=\"markdown-img-link\" src=\"https://images.ecency.com/p/2BCfkBRHmbhyg7yeHaumxJq2oMZjKUDK5rv2tmGQzQHxPvTmaiv6Ar?format=match&amp;mode=fit\" loading=\"lazy\" decoding=\"async\" itemprop=\"image\" /> dolor sit amet</p>`
}
...
describe('Markdown2Html', () => {
  describe('Traversing', () => {
    it('1- Should convert image links to img tag', () => {
      ...
      const expected = '<p dir=\"auto\"><img class="markdown-img-link" src="https://images.ecency.com/p/o1AJ9qDyyJNSpZWhUgGYc3MngFqoAMwgbeMkkd8SVxyfRVjiN?format=match&amp;mode=fit" loading="lazy" decoding="async" itemprop="image" /></p>'
    ...
    it('50 - Should handle user slash link', () => {
      ...
      const expected = '<p dir=\"auto\"><a class=\"markdown-author-link\" data-author=\"hivesql\"><img src=\"https://images.ecency.com/p/2bP4pJr4wVimqCWjYimXJe2cnCgn8gbL3c5wQPJF23G?format=match&amp;mode=fit\" itemprop=\"image\" loading=\"eager\" fetchpriority=\"high\" /></a></p>'
      expect(markdown2Html(input)).toBe(expected)
    })
