...
var xmldom__default = /*#__PURE__*/_interopDefault(xmldom);
...
var DOMParser = new xmldom__default.default.DOMParser({
...
function getSerializedInnerHTML(node) {
  const XMLSerializer = new xmldom__default.default.XMLSerializer();
