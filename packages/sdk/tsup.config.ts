...
export default defineConfig([
    // Browser build
    {
        ...
        //
        // The node build below stays a single bundle on purpose: plain Node loads
        // it with no bundler in front of it, so splitting would buy nothing there
        // and the directory-import hazard noted in render-helper applies.
