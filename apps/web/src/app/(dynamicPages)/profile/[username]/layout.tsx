...
export default async function ProfileLayout({ children, params }: Props) {
  ...
  return (
    <div className="reading-page reading-background">
      <ScrollToTop />
      <Theme />
      <Feedback />
      <Navbar />
      <div className="pb-20 md:pb-0 profile-page reading-list-layout max-w-[1600px] sm:px-2 md:px-2 mx-auto flex flex-col lg:flex-row gap-0 sm:gap-4 min-h-[100vh] items-start w-full">
        <div className="reading-surface border border-[--border-color] rounded-xl lg:min-w-[280px] lg:max-w-[280px] w-full overflow-hidden">
