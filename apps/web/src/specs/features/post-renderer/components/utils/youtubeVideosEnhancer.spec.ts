...
import { applyYoutubeVideos } from '@/features/post-renderer/components/utils/youtubeVideosEnhancer'
...
vi.mock('@/features/post-renderer/components/utils/getYoutubeEmbedUrl', () => ({
...
describe('applyYoutubeVideos', () => {
  ...
  describe('basic functionality', () => {
    ...
    it('should set embedSrc from getYoutubeEmbedUrl', async () => {
      const { getYoutubeEmbedUrl } = await import('@/features/post-renderer/components/utils/getYoutubeEmbedUrl')
