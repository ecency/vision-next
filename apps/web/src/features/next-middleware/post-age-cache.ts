 ...
 *   - Uses `callRPC` from @ecency/sdk which tree-shakes to only the
 *     RPC call logic. Brings built-in node failover across multiple Hive
 *     RPC nodes with per-node health tracking and rate-limit awareness.
 */
