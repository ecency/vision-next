...
export const BADGE_STYLES: Record<BadgeAppearance, string> = {
  primary:
    "bg-blue-dark-sky-040 border border-blue-dark-sky-030 text-blue-dark-sky-active dark:bg-dark-default text-xs font-bold dark:border-blue-metallic-20 dark:text-gray-200",
  secondary:
