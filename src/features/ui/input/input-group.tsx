  ...
  return (
    ...
    >
      {prepend ? (
        <div
          className={classNameObject({
            "ecency-input-group-part ecency-input-group-prepend flex items-center justify-center border-r-0 rounded-tl-full rounded-bl-full bg-gray-200 dark:border-dark-600-005-light dark:hover:border-dark-600-010-light dark:bg-dark-default":
              true,
      ...
      {append ? (
        <div
          className={classNameObject({
            "ecency-input-group-part ecency-input-group-append border-l-0 rounded-tr-full rounded-br-full bg-gray-200 dark:border-dark-600-005-light dark:hover:border-dark-600-010-light dark:bg-dark-default":
              true,
