...
export const FloatingFAQ = () => {
  ...
  const [helpClass, setHelpClass] = useState("[...sections] flex flex-col");
  const [contactClass, setContactClass] = useState("[...sections] flex flex-col");
  ...
  useEffect(() => {
    if (expandedHelp) {
      setHelpClass("[...sections] flex flex-col border-b border-[--border-color]");
    }
    if (expandedContact) {
      setContactClass("[...sections] flex flex-col border-b border-[--border-color]");
    }
