...
export function CreateCommunityPage() {
  ...
  return (
    <div className="grid grid-cols-12 gap-4 lg:gap-6 xl:gap-8 items-center justify-center w-full">
      <CommunityCreateImage />
      <div className="col-span-12 sm:col-span-8 lg:col-span-6 p-4 lg:p-6 xl:p-8 border border-[--border-color] rounded-2xl bg-white dark:bg-gray-900 w-full md:w-[600px] mx-auto">
