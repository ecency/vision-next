...
import { ManageAuthorities } from "@/app/(dynamicPages)/profile/[username]/_components/manage-authority";
import { AccountRecovery } from "@/app/(dynamicPages)/profile/[username]/_components/recovery-account";
import { PasswordUpdate } from "@/app/(dynamicPages)/profile/[username]/_components/password-update";
